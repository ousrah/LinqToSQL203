...
namespace LinqToSQL203
{
    public partial class Form1 : Form
    {
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            var ed = from edi in db.EDITEUR
                     join ouv in db.OUVRAGE  on edi.NOMED equals ouv.NOMED
                     join clas in db.CLASSIFICATION on ouv.NUMRUB equals clas.NUMRUB

                     group edi by new { edi.NOMED, clas.LIBRUB } into G_edi
                     select new { editeur = G_edi.Key.NOMED, classificaton = G_edi.Key.LIBRUB,  nbouvrages = G_edi.Count() };
